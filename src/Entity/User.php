...
#[UniqueEntity(fields: ['email'], message: 'Cet adresse email est déjà prise')]
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Candidate::class,  cascade: ['remove'])]
    private Collection $candidates;

    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Vote::class,  cascade: ['remove'])]
    private Collection $votes;

    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Voter::class,  cascade: ['remove'])]
    private Collection $voters;

    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Election::class, cascade: ['remove'])]
